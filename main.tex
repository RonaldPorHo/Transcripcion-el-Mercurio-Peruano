...
% Definir un nuevo comando para el cuadro decorativo
\newcommand{\decorativeTitle}[3]{
    % 1. Iniciamos un entorno que nos permite desplazar el contenido
    \begin{list}{}{
        % 2. Aplicamos un margen izquierdo negativo para desplazar todo hacia la izquierda
        \setlength{\leftmargin}{-0.55cm} % <-- VALOR DE DESPLAZAMIENTO A LA IZQUIERDA
        \setlength{\rightmargin}{0cm}
        \setlength{\topsep}{0pt}
        \setlength{\partopsep}{0pt}
    }
    \item % Iniciamos el item para aplicar el desplazamiento
    \begin{center}
        % Cuadro decorativo con un borde grueso
        \begin{tikzpicture}[
            every node/.style={inner sep=0pt},
            % Puedes ajustar el color de los ornamentos aquí
            % pgfornamentstyle/.style={color=black, fill=black} 
        ]
        ...
        { 
            ...
            \Large {#2} \\[10pt] % Subtítulo (opcional)
            \small \textit{#3} % Número (opcional)
        };

        % Colocamos ornamentos en las esquinas del cuadro
        ...
        % Ornamento en los lados verticales
        ...
        % Líneas ornamentales horizontales en la parte superior e inferior
        \pgfornamenthline{north west}{north east}{north}{89}
        \pgfornamenthline{south west}{south east}{south}{89}
        \end{tikzpicture}
    \end{center}
    \end{list} % 3. Cerramos el entorno list para que el resto del texto no se vea afectado
}

\begin{document}

% Título principal con cuadro decorativo
